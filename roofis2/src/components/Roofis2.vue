 ...
 */
    ...
    *, *::before, *::after {
    ...
    .form-control:focus {
        ...
        border-color: #30aef6;
        outline: 0;
        box-shadow: 0 0 0 .2rem rgba(7, 104, 159, 0.25)
    }
    ...
    .was-validated .form-control:valid:focus, .form-control.is-valid:focus {
        border-color: #11D3BC;
        box-shadow: 0 0 0 .2rem rgba(17, 211, 188, 0.25)
    }
    ...
    .was-validated .custom-select:valid, .custom-select.is-valid {
        ...
        background: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 4 5'%3e%3cpath fill='%23343a40' d='M2 0L0 2h4zm0 5L0 3h4z'/%3e%3c/svg%3e") no-repeat right .75rem center/8px 10px, url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%2311D3BC' d='M2.3 6.73L.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1z'/%3e%3c/svg%3e") #fff no-repeat center right 1.75rem/calc(.75em + .375rem) calc(.75em + .375rem)
    }
    ...
    .was-validated .form-control:invalid, .form-control.is-invalid {
        border-color: #F67280;
        padding-right: calc(1.5em + .75rem);
        background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' fill='%23F67280' viewBox='-2 -2 7 7'%3e%3cpath stroke='%23F67280' d='M0 0l3 3m0-3L0 3'/%3e%3ccircle r='.5'/%3e%3ccircle cx='3' r='.5'/%3e%3ccircle cy='3' r='.5'/%3e%3ccircle cx='3' cy='3' r='.5'/%3e%3c/svg%3E");
        background-repeat: no-repeat;
        background-position: center right calc(.375em + .1875rem);
        background-size: calc(.75em + .375rem) calc(.75em + .375rem)
    }
    ...
    .was-validated .form-control:invalid:focus, .form-control.is-invalid:focus {
        border-color: #F67280;
        box-shadow: 0 0 0 .2rem rgba(246, 114, 128, 0.25)
    }
    ...
    .was-validated .custom-select:invalid, .custom-select.is-invalid {
        border-color: #F67280;
        padding-right: calc((1em + .75rem) * 3 / 4 + 1.75rem);
        background: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 4 5'%3e%3cpath fill='%23343a40' d='M2 0L0 2h4zm0 5L0 3h4z'/%3e%3c/svg%3e") no-repeat right .75rem center/8px 10px, url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' fill='%23F67280' viewBox='-2 -2 7 7'%3e%3cpath stroke='%23F67280' d='M0 0l3 3m0-3L0 3'/%3e%3ccircle r='.5'/%3e%3ccircle cx='3' r='.5'/%3e%3ccircle cy='3' r='.5'/%3e%3ccircle cx='3' cy='3' r='.5'/%3e%3c/svg%3E") #fff no-repeat center right 1.75rem/calc(.75em + .375rem) calc(.75em + .375rem)
    }
    ...
    .btn-primary:focus, .btn-primary.focus {
        box-shadow: 0 0 0 .2rem rgba(44, 127, 173, 0.5)
    }
    ...
    .btn-secondary:focus, .btn-secondary.focus {
        box-shadow: 0 0 0 .2rem rgba(176, 187, 196, 0.5)
    }
    ...
    .btn-success:focus, .btn-success.focus {
        box-shadow: 0 0 0 .2rem rgba(19, 185, 166, 0.5)
    }
    ...
    .btn-info:focus, .btn-info.focus {
        box-shadow: 0 0 0 .2rem rgba(143, 187, 212, 0.5)
    }
    ...
    .btn-warning:focus, .btn-warning.focus {
        box-shadow: 0 0 0 .2rem rgba(222, 113, 94, 0.5)
    }
    ...
    .btn-danger:focus, .btn-danger.focus {
        box-shadow: 0 0 0 .2rem rgba(214, 102, 115, 0.5)
    }
    ...
    .btn-outline-primary:focus, .btn-outline-primary.focus {
        box-shadow: 0 0 0 .2rem rgba(7, 104, 159, 0.5)
    }
    ...
    .btn-outline-secondary:focus, .btn-outline-secondary.focus {
        box-shadow: 0 0 0 .2rem rgba(201, 214, 223, 0.5)
    }
    ...
    .btn-outline-success:focus, .btn-outline-success.focus {
        box-shadow: 0 0 0 .2rem rgba(17, 211, 188, 0.5)
    }
    ...
    .btn-outline-info:focus, .btn-outline-info.focus {
        box-shadow: 0 0 0 .2rem rgba(162, 213, 242, 0.5)
    }
    ...
    .btn-outline-warning:focus, .btn-outline-warning.focus {
        box-shadow: 0 0 0 .2rem rgba(255, 126, 103, 0.5)
    }
    ...
    .btn-outline-danger:focus, .btn-outline-danger.focus {
        box-shadow: 0 0 0 .2rem rgba(246, 114, 128, 0.5)
    }
    ...
    .btn-outline-dark:focus, .btn-outline-dark.focus {
        box-shadow: 0 0 0 .2rem rgba(78, 78, 78, 0.5)
    }
    ...
    .custom-range:focus::-webkit-slider-thumb {
        box-shadow: 0 0 0 1px #fff, 0 0 0 .2rem rgba(7, 104, 159, 0.25)
    }
